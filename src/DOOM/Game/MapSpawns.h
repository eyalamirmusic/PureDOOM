...
namespace Doom
{
// Where players and deathmatch frags spawn on the current map. P_SetupLevel walks the map's
...
// PureDOOM is single-player, so only playerstarts[0] is really used, but P_LoadThings fills
