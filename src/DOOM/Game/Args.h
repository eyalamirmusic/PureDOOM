...
// The command line, owned by Game/Args.cpp. Was an `extern` global; myargv() hands
// out the file-local vector, read and written as myargv()[i] / myargv() = args.
...
namespace Doom
{
// Command-line argument lookup; m_argv.cpp keeps checkParm as a shim.
