...
// which a constexpr std::string_view cannot do. Keeping these two as macros is
...
constexpr std::string_view QLOADNET =
    "you can't quickload during a netgame!\n\n" PRESSKEY;
constexpr std::string_view QSAVESPOT =
    "you haven't picked a quicksave slot yet!\n\n" PRESSKEY;
constexpr std::string_view SAVEDEAD =
    "you can't save if you aren't playing!\n\n" PRESSKEY;
constexpr std::string_view QSPROMPT =
    "quicksave over your game named\n\n'%s'?\n\n" PRESSYN;
constexpr std::string_view QLPROMPT =
    "do you want to quickload the game named\n\n'%s'?\n\n" PRESSYN;

constexpr std::string_view QSPROMPT_1 = "quicksave over your game named\n\n'";
constexpr std::string_view QSPROMPT_2 = "'?\n\n" PRESSYN;
constexpr std::string_view QLPROMPT_1 =
    "do you want to quickload the game named\n\n'%s";
constexpr std::string_view QLPROMPT_2 = "'?\n\n" PRESSYN;
...
constexpr std::string_view SWSTRING =
    "this is the shareware version of doom.\n\n"
    "you need to order the entire trilogy.\n\n" PRESSKEY;

constexpr std::string_view MSGOFF = "Messages OFF";
constexpr std::string_view MSGON = "Messages ON";
constexpr std::string_view CROSSOFF = "Crosshair OFF";
constexpr std::string_view CROSSON = "Crosshair ON";
constexpr std::string_view ALWAYSRUNOFF = "Always run OFF";
constexpr std::string_view ALWAYSRUNON = "Always run ON";
constexpr std::string_view NETEND = "you can't end a netgame!\n\n" PRESSKEY;
constexpr std::string_view ENDGAME =
    "are you sure you want to end the game?\n\n" PRESSYN;

// Stays a macro: UI/Menu.cpp concatenates it as `"\n\n" DOSY`, which is
// adjacent-literal concatenation at translation phase 6 - a constexpr
// std::string_view cannot do it. Same reason as PRESSKEY/PRESSYN above.
...
constexpr std::string_view STSTR_BEHOLD =
...
constexpr std::string_view E2TEXT = "You've done it! The hideous cyber-\n"
...
constexpr std::string_view E3TEXT = "The loathsome spiderdemon that\n"
...
constexpr std::string_view E4TEXT = "the spider mastermind must have sent forth\n"
...
constexpr std::string_view T1TEXT = "You've fought your way out of the infested\n"
...
constexpr std::string_view T2TEXT = "You hear the grinding of heavy machinery\n"
...
constexpr std::string_view T3TEXT = "The vista opening ahead looks real damn\n"
...
constexpr std::string_view T4TEXT = "Suddenly, all is silent, from one horizon\n"
...
constexpr std::string_view T5TEXT = "What now? Looks totally different. Kind\n"
                                    "of like King Tut's condo. Well,\n"
                                    "whatever's here can't be any worse\n"
                                    "than usual. Can it?  Or maybe it's best\n"
                                    "to let sleeping gods lie..";

constexpr std::string_view T6TEXT = "Time for a vacation. You've burst the\n"
