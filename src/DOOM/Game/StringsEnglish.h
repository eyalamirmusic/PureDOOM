...
// adjacent-literal concatenation, which happens at translation phase 6 and
// which a constexpr const char* cannot do. Keeping these two as macros is
...
constexpr const char* LOADNET =
    "you can't do load while in a net game!\n\n" PRESSKEY;
constexpr const char* QLOADNET =
    "you can't quickload during a netgame!\n\n" PRESSKEY;
constexpr const char* QSAVESPOT =
    "you haven't picked a quicksave slot yet!\n\n" PRESSKEY;
constexpr const char* SAVEDEAD =
    "you can't save if you aren't playing!\n\n" PRESSKEY;
constexpr const char* QSPROMPT =
    "quicksave over your game named\n\n'%s'?\n\n" PRESSYN;
constexpr const char* QLPROMPT =
    "do you want to quickload the game named\n\n'%s'?\n\n" PRESSYN;

constexpr const char* QSPROMPT_1 = "quicksave over your game named\n\n'";
constexpr const char* QSPROMPT_2 = "'?\n\n" PRESSYN;
constexpr const char* QLPROMPT_1 = "do you want to quickload the game named\n\n'%s";
constexpr const char* QLPROMPT_2 = "'?\n\n" PRESSYN;
...
constexpr const char* CROSSOFF = "Crosshair OFF";
constexpr const char* CROSSON = "Crosshair ON";
constexpr const char* ALWAYSRUNOFF = "Always run OFF";
constexpr const char* ALWAYSRUNON = "Always run ON";
constexpr const char* NETEND = "you can't end a netgame!\n\n" PRESSKEY;
constexpr const char* ENDGAME = "are you sure you want to end the game?\n\n" PRESSYN;

// Stays a macro: UI/Menu.cpp concatenates it as `"\n\n" DOSY`, which is
// adjacent-literal concatenation at translation phase 6 - a constexpr
// const char* cannot do it. Same reason as PRESSKEY/PRESSYN above.
...
namespace Doom
{
constexpr const char* E1TEXT = "Once you beat the big badasses and\n"
...
constexpr const char* E2TEXT = "You've done it! The hideous cyber-\n"
...
constexpr const char* E3TEXT = "The loathsome spiderdemon that\n"
...
constexpr const char* E4TEXT = "the spider mastermind must have sent forth\n"
...
namespace Doom
{
constexpr const char* C1TEXT = "YOU HAVE ENTERED DEEPLY INTO THE INFESTED\n"
...
namespace Doom
{
constexpr const char* C2TEXT = "YOU HAVE WON! YOUR VICTORY HAS ENABLED\n"
...
namespace Doom
{
constexpr const char* C3TEXT = "YOU ARE AT THE CORRUPT HEART OF THE CITY,\n"
...
namespace Doom
{
constexpr const char* C4TEXT = "THE HORRENDOUS VISAGE OF THE BIGGEST\n"
...
namespace Doom
{
constexpr const char* C5TEXT = "CONGRATULATIONS, YOU'VE FOUND THE SECRET\n"
...
namespace Doom
{
constexpr const char* C6TEXT = "CONGRATULATIONS, YOU'VE FOUND THE\n"
...
namespace Doom
{
constexpr const char* P1TEXT = "You gloat over the steaming carcass of the\n"
...
namespace Doom
{
constexpr const char* P2TEXT = "Even the deadly Arch-Vile labyrinth could\n"
...
namespace Doom
{
constexpr const char* P3TEXT = "You've bashed and battered your way into\n"
...
namespace Doom
{
constexpr const char* P4TEXT = "The Gatekeeper's evil face is splattered\n"
...
namespace Doom
{
constexpr const char* P5TEXT = "You've found the second-hardest level we\n"
...
namespace Doom
{
constexpr const char* P6TEXT = "Betcha wondered just what WAS the hardest\n"
                               "level we had ready for ya?  Now you know.\n"
                               "No one gets out alive.";

constexpr const char* T1TEXT = "You've fought your way out of the infested\n"
...
constexpr const char* T2TEXT = "You hear the grinding of heavy machinery\n"
...
constexpr const char* T3TEXT = "The vista opening ahead looks real damn\n"
...
constexpr const char* T4TEXT = "Suddenly, all is silent, from one horizon\n"
...
constexpr const char* T5TEXT = "What now? Looks totally different. Kind\n"
                               "of like King Tut's condo. Well,\n"
                               "whatever's here can't be any worse\n"
                               "than usual. Can it?  Or maybe it's best\n"
                               "to let sleeping gods lie..";

constexpr const char* T6TEXT = "Time for a vacation. You've burst the\n"
