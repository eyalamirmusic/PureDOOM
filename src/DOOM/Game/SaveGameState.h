...
namespace Doom
{
// The savegame serialization / orchestration state. G_DoSaveGame / doLoadGame set
...
// test-covered (the probe sets it and walks it through archiveThinkers /
// unArchiveThinkers); buffer and name are exercised by the app's save/load, and a
...
// alone, filled directly by readFile (whose out-parameter became this owner, its only
