...
// running, doAdvanceDemo walks demosequence through a fixed cycle (title, a recorded demo,
...
// loop advances. advancedemo is the request flag - advanceDemo raises it, and displayFrame runs
// doAdvanceDemo on the next tic - so the advance happens between tics rather than mid-draw.
