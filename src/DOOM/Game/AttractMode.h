...
// running, D_DoAdvanceDemo walks demosequence through a fixed cycle (title, a recorded demo,
...
// loop advances. advancedemo is the request flag - D_AdvanceDemo raises it, and D_Display runs
// D_DoAdvanceDemo on the next tic - so the advance happens between tics rather than mid-draw.
...
// NetUpdate) and pagename one in Game/Game.cpp's page drawer; those move to references in step.
