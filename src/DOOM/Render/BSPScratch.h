...
// front/back sectors it belongs to (set as subsector / addLine walk the tree), plus the
...
// by clearDrawSegs each frame, not by a self-referential initializer, so it is safe as a
