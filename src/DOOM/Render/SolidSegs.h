...
namespace Doom
{
// The BSP occlusion clip ranges (clearClipSegs / clipSolidWallSegment): as the BSP is walked
...
// reference-to-array; newend points into solidsegs but is set at runtime by clearClipSegs, not
