...
// ---------------------------------------------------------------------------
// What was r_things.cpp's file-scope data. Every name below has moved onto the
// Engine; the notes record where each went.
// ---------------------------------------------------------------------------
// The sprite-drawing state r_things exports is a SpriteState owned by the Engine now; the
