...
void stloadData(void)
{
    lu_palette = W_GetNumForName("PLAYPAL");
    stloadGraphics();
}

void stunloadGraphics(void)
{
...
void stunloadData(void)
{
    stunloadGraphics();
}

void stinitData(void)
{
    int i;
