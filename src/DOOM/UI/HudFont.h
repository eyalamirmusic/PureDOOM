...
// message-drawing helper all render text with. startHud caches HU_FONTSTART..HU_FONTEND
...
// UI/Finale and Game/Config. startHud writes the array, so those definitions and every extern
