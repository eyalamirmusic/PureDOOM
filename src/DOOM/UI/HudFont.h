...
// message-drawing helper all render text with. HU_Start caches HU_FONTSTART..HU_FONTEND
...
// UI/Finale and Game/Config. HU_Start writes the array, so those definitions and every extern
