...
// source, so they name MF_*/S_*/SPR_* unqualified.
namespace Doom
{
...
// The three tables above are file-local storage; these hand them out. See
// Sim/Info.h for why states/mobjinfo are pointers and sprnames a const reference.
State* states()
{
    return statesData;
}
