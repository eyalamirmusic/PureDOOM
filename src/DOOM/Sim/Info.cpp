...
// The action functions below are declared with their real signatures now. As C,
// `void A_Look();` meant "takes unspecified arguments" and linked against
// A_Look(mobj_t*); as C++ it means "takes none", and would not.
#include "../d_player.h"
#include "../p_pspr.h"
