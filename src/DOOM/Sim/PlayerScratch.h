...
// own namespace-scope private global, read by no other file. The vanilla name becomes a reference
// onto the member. Live simulation-golden-covered - the demos walk every tic - so the byte-identical
