...
namespace Doom
{
// Teleport `thing` to the MobjType::Teleportman in a sector tagged by `line`, with fog and
// sound. Returns 1 if it teleported, 0 otherwise. p_telept.cpp keeps the vanilla
// name teleport as a shim (p_spec/p_switch call it). Golden-neutral; the demos
// walk teleporters.
