...
//     removeThinker sets the flag, and runThinkers unlinks and frees the block
...
//     (ceilingCrushStop / stopPlat) stays on the list but is skipped by
...
struct Thinker
{
    ...
    // nothing; runThinkers skips them without calling this.
    virtual void tick() {}
